    ...
    <div class="container">
      <section id="profile">
        <div class="d-flex align-items-center gap-4">
          <div>
            <img src="" alt="Profile" class="img-fluid" width="80">
          </div>
          <div>
      ...
      <section id="my-videos" class="mt-5">
        ...
        <div class="row g-5">
            ...
            <a href="" class="col-4 image-card py-4">
              <img src="" alt="" class="img-fluid">
              <div class="d-flex align-items-start gap-3 mt-2">
                <img src="" alt="" class="img-fluid" width="45">
                <div>
                  <p class="fw-bold m-0 mt-2"></p>
                  <small class="text-secondary fw-bold d-block"></small>
                  <small class="text-secondary fw-bold"></small>
                </div>
              </div>
            </a>
